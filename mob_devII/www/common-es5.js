...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY_1 = 'favouriteCharacter';
    ...
    var FavouriteService = /*#__PURE__*/function () {
      ...
      _createClass(FavouriteService, [{
        ...
        key: "getAllFavouriteCharacter",
        value: function getAllFavouriteCharacter() {
          return this.storage.get(STORAGE_KEY_1);
        }
      }, {
        key: "isFavouriteCharacter",
        value: function isFavouriteCharacter(characterId) {
          return this.getAllFavouriteCharacter().then(function (result) {
        ...
        value: function favouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacter().then(function (result) {
            if (result) {
              ...
              return _this3.storage.set(STORAGE_KEY_1, result);
            } else {
              return _this3.storage.set(STORAGE_KEY_1, [characterId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacter().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this4.storage.set(STORAGE_KEY_1, result);
            }
          });
        }
      }]);
