...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["quotes-quotes-module"], {
  ...
  function srcAppPagesQuotesQuotesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var QuotesPage = /*#__PURE__*/function () {
      function QuotesPage(navController, router, api) {
      ...
      _createClass(QuotesPage, [{
        ...
        value: function initializeItems() {
          this.items = ['I am not in danger,Skyler.I am the danger!', 'Stay out of my territory', 'IFT', 'Say my name', 'I watched Jane die.I was there.And I watched her die.I wathched her overdose and choque to death'];
        }
      }, {
        key: "getItems",
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]])], QuotesPage);
    /***/
  }
}]);
